...
Source0  : https://github.com/tpope/vim-fugitive/archive/v3.6/vim-fugitive-3.6.tar.gz
...
%prep
%setup -q -n vim-fugitive-3.6
cd %{_builddir}/vim-fugitive-3.6
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1638376622
